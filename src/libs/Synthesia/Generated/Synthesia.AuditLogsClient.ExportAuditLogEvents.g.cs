...
namespace Synthesia
{
    public partial class AuditLogsClient
    {
                ...
                else
                {
                    await global::Synthesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            try
                            {
                                ...
                                return new global::Synthesia.ResponseStream(__response, __content);
                            }
                            catch (global::System.Exception __ex)
                            {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Synthesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Synthesia.AutoSDKHttpResponse<byte[]>> ExportAuditLogEventsAsResponseAsync(
                    ...
                    await global::Synthesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Synthesia.AutoSDKHttpResponse<byte[]>(
                                        statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<byte[]> ExportAuditLogEventsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Synthesia.AuditLogsExportRequest
            {
