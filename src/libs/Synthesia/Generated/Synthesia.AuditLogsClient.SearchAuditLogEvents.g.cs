...
namespace Synthesia
{
    public partial class AuditLogsClient
    {
        ...
        private static readonly global::Synthesia.EndPointSecurityRequirement s_SearchAuditLogEventsSecurityRequirement0 =
        ...
        private static readonly global::Synthesia.EndPointSecurityRequirement[] s_SearchAuditLogEventsSecurityRequirements =
            new global::Synthesia.EndPointSecurityRequirement[]
            {                s_SearchAuditLogEventsSecurityRequirement0,
            };
        partial void PrepareSearchAuditLogEventsArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Synthesia.AuditLogsQueryRequest request);
        partial void PrepareSearchAuditLogEventsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Synthesia.AuditLogsQueryRequest request);
        partial void ProcessSearchAuditLogEventsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchAuditLogEventsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Synthesia.AuditLogsPageResponse> SearchAuditLogEventsAsync(

            global::Synthesia.AuditLogsQueryRequest request,
            global::Synthesia.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SearchAuditLogEventsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Synthesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Synthesia.AutoSDKHttpResponse<global::Synthesia.AuditLogsPageResponse>> SearchAuditLogEventsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSearchAuditLogEventsArguments(
            ...
            var __authorizations = global::Synthesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SearchAuditLogEventsSecurityRequirements,
                operationName: "SearchAuditLogEventsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSearchAuditLogEventsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Synthesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Synthesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SearchAuditLogEvents",
                                methodName: "SearchAuditLogEventsAsync",
                                pathTemplate: "\"/v2/auditLogs/events/search\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSearchAuditLogEventsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Synthesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::Synthesia.Error? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::Synthesia.Error.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSearchAuditLogEventsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Synthesia.AuditLogsPageResponse> SearchAuditLogEventsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Synthesia.AuditLogsQueryRequest
            {
            ...
            return await SearchAuditLogEventsAsync(
                request: __request,
                requestOptions: requestOptions,
