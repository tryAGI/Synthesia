...
namespace Synthesia
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Synthesia.AutoSDKRetryOptions Retry { get; set; } = new global::Synthesia.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Synthesia.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Synthesia.IAutoSDKHook>();
        ...
        public global::Synthesia.AutoSDKClientOptions AddHook(
            global::Synthesia.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Synthesia.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Synthesia.AutoSDKClientOptions UseAuthorizationProvider(
            global::Synthesia.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Synthesia.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Synthesia.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Synthesia.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Synthesia.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Synthesia.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Synthesia.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Synthesia.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Synthesia.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Synthesia.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Synthesia.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Synthesia.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Synthesia.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Synthesia.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Synthesia.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Synthesia.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Synthesia.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Synthesia.AutoSDKClientOptions clientOptions,
            global::Synthesia.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Synthesia.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Synthesia.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Synthesia.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Synthesia.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Synthesia.IAutoSDKHook, global::Synthesia.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Synthesia.AutoSDKHookContext context)
        {
