...
namespace Synthesia
{
    public partial class DubbingClient
    {
        ...
        private static readonly global::Synthesia.EndPointSecurityRequirement s_CreateDubbingSecurityRequirement0 =
        ...
        private static readonly global::Synthesia.EndPointSecurityRequirement[] s_CreateDubbingSecurityRequirements =
            new global::Synthesia.EndPointSecurityRequirement[]
            {                s_CreateDubbingSecurityRequirement0,
            };
        ...
        public async global::System.Threading.Tasks.Task<global::Synthesia.CreateDubbingProjectApiResponseSuccess> CreateDubbingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Synthesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateDubbingSecurityRequirements,
                operationName: "CreateDubbingAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Synthesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Synthesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateDubbingAsync",
                                pathTemplate: "\"/v2/dubbing\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Synthesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Synthesia.OneOf<global::Synthesia.CreateDubbingProjectApiResponseFail, global::Synthesia.CreateDubbingResponse2>? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Synthesia.OneOf<global::Synthesia.CreateDubbingProjectApiResponseFail, global::Synthesia.CreateDubbingResponse2>.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Synthesia.ApiException<global::Synthesia.OneOf<global::Synthesia.CreateDubbingProjectApiResponseFail, global::Synthesia.CreateDubbingResponse2>?>.Create(
                            ...
                            if ((int)__response.StatusCode == 501)
                            {
                                ...
                                global::Synthesia.CreateDubbingResponse3? __value_501 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_501 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_501 = global::Synthesia.CreateDubbingResponse3.FromJson(__content_501, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_501 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Synthesia.ApiException<global::Synthesia.CreateDubbingResponse3>.Create(
                                    statusCode: __response.StatusCode,
        ...
        public async global::System.Threading.Tasks.Task<global::Synthesia.CreateDubbingProjectApiResponseSuccess> CreateDubbingAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Synthesia.OneOf<global::Synthesia.CreateDubbingProjectApiRequestFromSourceAssetId, global::Synthesia.CreateDubbingProjectApiRequestFromSourceVideoUrl?>
            {
            };
