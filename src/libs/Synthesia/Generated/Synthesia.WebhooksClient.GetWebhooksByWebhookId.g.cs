...
namespace Synthesia
{
    public partial class WebhooksClient
    {
        ...
        private static readonly global::Synthesia.EndPointSecurityRequirement s_GetWebhooksByWebhookIdSecurityRequirement0 =
        ...
        private static readonly global::Synthesia.EndPointSecurityRequirement[] s_GetWebhooksByWebhookIdSecurityRequirements =
            new global::Synthesia.EndPointSecurityRequirement[]
            {                s_GetWebhooksByWebhookIdSecurityRequirement0,
            };
        partial void PrepareGetWebhooksByWebhookIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string webhookId);
        partial void PrepareGetWebhooksByWebhookIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string webhookId);
        partial void ProcessGetWebhooksByWebhookIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWebhooksByWebhookIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Synthesia.WebhookResponse> GetWebhooksByWebhookIdAsync(
            string webhookId,
            global::Synthesia.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetWebhooksByWebhookIdAsResponseAsync(
                webhookId: webhookId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Synthesia.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Synthesia.AutoSDKHttpResponse<global::Synthesia.WebhookResponse>> GetWebhooksByWebhookIdAsResponseAsync(
            string webhookId,
            global::Synthesia.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetWebhooksByWebhookIdArguments(
            ...
            var __authorizations = global::Synthesia.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetWebhooksByWebhookIdSecurityRequirements,
                operationName: "GetWebhooksByWebhookIdAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Synthesia.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Synthesia.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetWebhooksByWebhookIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetWebhooksByWebhookIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Synthesia.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetWebhooksByWebhookIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Synthesia.WebhookResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Synthesia.AutoSDKHttpResponse<global::Synthesia.WebhookResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Synthesia.WebhookResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
