...
namespace Synthesia
{
    ...
    public sealed partial class AuditLogsPageResponse
    {
        ...
        public required global::System.Collections.Generic.IList<global::Synthesia.AuditLogEvent> Events { get; set; }
        ...
        public AuditLogsPageResponse(
            global::System.Collections.Generic.IList<global::Synthesia.AuditLogEvent> events,
            bool hasMore,
            string? nextCursor)
        {
