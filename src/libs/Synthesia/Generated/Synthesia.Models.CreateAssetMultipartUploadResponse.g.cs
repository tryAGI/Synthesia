...
namespace Synthesia
{
    ...
    public sealed partial class CreateAssetMultipartUploadResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Synthesia.MultipartUploadCredentialsResponse UploadCredentials { get; set; }
        ...
        public CreateAssetMultipartUploadResponse(
            string id,
            global::Synthesia.MultipartUploadCredentialsResponse uploadCredentials,
            string? uploadUrl)
        {
